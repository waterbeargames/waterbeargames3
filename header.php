...
<body <?php body_class('smooth-scroll-enabled'); ?>>
    ...
    <header id="header">
        <div class="row">
            <div class="column xs-span10 xs-left1 xs-right1 sm-span8 sm-left2 sm-right2 md-span6 md-left0 md-right0">
            ...
            <div class="column xs-span12 md-span6">
                <div class="column-inner home-buttons">
                    ...
                    <div class="home-button">
                        <div class="home-button-icon-container">
